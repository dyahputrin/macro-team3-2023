...
struct ScenekitView: UIViewRepresentable {
    ...
    func makeUIView(context: Context) -> SCNView {
        ...
        view.defaultCameraController.translateInCameraSpaceBy(x: 0, y: 0, z: (roomWidth) - 1)
        
        let tapGesture = UITapGestureRecognizer(target: context.coordinator, action: #selector(context.coordinator.handleTap(_:)))
        view.addGestureRecognizer(tapGesture)
        
        view.isHidden = !isViewVisible
    ...
    func updateUIView(_ uiView: SCNView, context: Context) {
        ...
        uiView.isHidden = !isViewVisible
    }

    func makeCoordinator() -> Coordinator {
//        Coordinator(self)
        return Coordinator(self, isViewVisible: isViewVisible)
    }
...
class Coordinator: NSObject, UIGestureRecognizerDelegate {
    ...
    init(_ parent: ScenekitView, isViewVisible: Bool) {
        self.parent = parent
    ...
    func viewDidDisappear() {
       ...
       isViewVisible = false // Set visibility when view disappears
   ...
   func viewDidAppear() {
       ...
       isViewVisible = true // Set visibility when view appears
       deselectNodeAndArrows()
       // Additional logic as needed
   }
