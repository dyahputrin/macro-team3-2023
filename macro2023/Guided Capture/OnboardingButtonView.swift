...
//        VStack {
//            HStack {
//                CancelButton(appModel: appModel, buttonLabel: LocalizedString.cancel)
//                Spacer()
//            }
//
//            Spacer()
...
//                    CreateButton(appModel: appModel, buttonLabel: LocalizedString.continue,
...
//                    CreateButton(appModel: appModel, buttonLabel: LocalizedString.flipAnyway,
...
//                    CreateButton(appModel: appModel, buttonLabel: LocalizedString.skip,
//                                 buttonLabelColor: .blue,
//                                 action: {
...
//                    CreateButton(appModel: appModel, buttonLabel: LocalizedString.finish,
...
//                    CreateButton(appModel: appModel, buttonLabel: LocalizedString.cannotFlipYourObject,
//                                 buttonLabelColor: .blue,
//                                 action: {
...
//                    CreateButton(appModel: appModel, buttonLabel: "", action: {})
//                }
//            }
//            .padding(.bottom)
//        }
